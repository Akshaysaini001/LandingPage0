        ...
        <div className='container'>
          <div className='row'>
            ...
            <div className='footer-col' data-aos='slide-up'>
              ...
              <ul>
                <li>
                  <a href='mailto:iamsainiakshay@gmail.com?body=fell free to type'>
                    Gmail
                  </a>
                </li>
                <li>
                  <a href='tel:9568071202'>Helpline No</a>
                </li>
              </ul>
            </div>
            <div className='footer-col' data-aos='slide-up'>
              ...
              <div className='social-links' data-aos='flip-up'>
                <a
                  href='https://www.linkedin.com/in/akshay-saini-a08158217/'
                  target='blank'
                >
                  <FaLinkedin className=' mx-auto mt-3 scale-125' />
                </a>
                <a href='https://x.com/sain41046' target='blank'>
                  <FaTwitter className=' mx-auto mt-3 scale-125' />
                </a>

                <a
                  href='https://www.instagram.com/akshayy.saini/'
                  target='blank'
                >
                  <FaInstagram className=' mx-auto mt-3 scale-125' />
                </a>
                <a href='https://github.com/Akshaysaini001' target='blank'>
